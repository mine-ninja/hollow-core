...
public interface PlayerAccountService {
    ...
    /**
     * Obtém uma conta de jogador do cache remoto (Redis) pelo nome do jogador, se disponível.
     *
     * @param playerName Nome do jogador (não nulo).
     *
     * @return Conta do jogador ou null se não estiver no cache remoto.
     */
    @Nullable PlayerAccount loadFromRedisByName(@NotNull String playerName);
