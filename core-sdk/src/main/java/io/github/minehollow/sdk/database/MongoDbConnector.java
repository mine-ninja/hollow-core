package io.github.minehollow.sdk.database;
...
import io.github.minehollow.sdk.util.codec.mongo.CustomObjectCodecProvider;
...
public class MongoDbConnector {
    ...
    public static MongoDbConnector fromLocalProperty() {
        ...
        final var databaseName = Property.get("MONGO_DATABASE", "hollow");
