...
public class Time {
    ...
    public String toString() {
        ...
        time = this.appendTime(time, YEAR_MS, "anos", timeString);
        time = this.appendTime(time, DAY_MS, "dias", timeString);
        time = this.appendTime(time, HOUR_MS, "horas", timeString);
        time = this.appendTime(time, MINUTE_MS, "minutos", timeString);
        time = this.appendTime(time, SECOND_MS, "segundos", timeString);
