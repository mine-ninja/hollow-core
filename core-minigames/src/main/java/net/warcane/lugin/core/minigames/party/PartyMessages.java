...
public final class PartyMessages {
    public static final String NOT_IN_PARTY = "§cVocê não está em uma party.";
    public static final String ALREADY_IN_PARTY = "<red>Você já está em uma party. Saia da sua party atual para aceitar um novo convite.";
    public static final String ONLY_LEADER = "§cApenas o líder da party pode realizar esta ação.";
    public static final String PARTY_FULL = "§cA party está cheia.";
    public static final String PLAYER_NOT_ONLINE = "<red>O jogador não está online.";
    public static final String PROCESS_ERROR = "<red>Ocorreu um erro ao processar sua solicitação. Tente novamente mais tarde.";
    public static final String NO_INVITE = "§cNão há um convite pendente de %s.";
