...
public class PartyLeaveSubcommand extends SimpleSubCommand {

    private final MinigamesPlatform platform;

    public PartyLeaveSubcommand(MinigamesPlatform platform) {
        super("sair");
    ...
    protected void performSubCommand(CommandContext ctx) throws CommandFailedException {
        platform.getPartyService().leaveParty(ctx.getSenderAsPlayer());
    }
}
