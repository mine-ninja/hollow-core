...
public class ClanConfirmationMenu extends SimpleMenu {
    ...
    public boolean onPreOpen(@NotNull PlayerMenuContext ctx, @NotNull MenuConfig openHandler) {
        ...
        // ── Description item ──
        ctx.setItem(
            'D', ItemBuilder.of(action.equals(ACTION_DISBAND) ? Material.TNT : Material.GOLDEN_HELMET)
        ...
        // ── Confirm button ──
        ctx.setItem(
            'C', ItemBuilder.of(Material.LIME_CONCRETE)
        ...
        // ── Cancel button ──
        ctx.setItem(
            'X', ItemBuilder.of(Material.RED_CONCRETE)
