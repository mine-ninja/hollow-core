package net.warcane.lugin.core.minecraft.util.permission.legacy;
...
import static net.warcane.lugin.core.minecraft.util.permission.legacy.CraftBukkitInterface.craftClassName;
...
public abstract class LegacyPermissibleInjector {
    ...
    static final LegacyPermissibleInjector[] INJECTORS = {
      new ClassPresenceLegacyPermissibleInjector(
    ...
    LegacyPermissibleInjector(final @Nullable String clazzName, String fieldName, boolean copyValues) {
    ...
    static final class ClassPresenceLegacyPermissibleInjector extends LegacyPermissibleInjector {
        ClassPresenceLegacyPermissibleInjector(final @Nullable String clazzName, final String fieldName, final boolean copyValues) {
