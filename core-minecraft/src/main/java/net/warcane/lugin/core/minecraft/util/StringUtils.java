...
public class StringUtils {
    ...
    public static Component multiText(@NotNull String... text) {
        ...
        for (String s : text) {
            Component texted = text(s);
            acc = acc.append(Component.newline()).append(texted);
        }
        return acc;
    }
    ...
    @NotNull
    public static TextReplacementConfig replace(@RegExp @NotNull String a, @NotNull String b) {
        return replaceComponent(a, text(b));
    }
    
    @NotNull
    public static TextReplacementConfig replaceComponent(@RegExp @NotNull String a, Component b) {
    ...
    public static Title title(Component title, Component subTitle, long fadeIn, long stay, long fadeOut) {
        return Title.title(title, subTitle, Title.Times.times(Duration.ofMillis(fadeIn), Duration.ofMillis(stay), Duration.ofMillis(fadeOut)));
    }
    ...
    public static List<String> matchPartial(String toMatch, List<String> options) {
        ...
        for (String option : options) {
            if (option.toLowerCase().startsWith(lowerToMatch)) {
                list.add(option);
            }
        }
        return list;
