...
public class Cooldown {
    ...
    public static CooldownInstance getCooldown(UUID uuid, String key) {
        return cooldownInstanceSet.stream()
                .filter(cooldownInstance -> uuid.equals(cooldownInstance.uuid())
                                            && cooldownInstance.key().equals(key))
                .findFirst()
                .orElse(null);
    }
    ...
    public static void removeCooldown(UUID uuid, String key) {
        cooldownInstanceSet.removeIf(cooldownInstance ->
                uuid.equals(cooldownInstance.uuid()) && cooldownInstance.key().equals(key));
    }
