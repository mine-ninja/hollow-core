 ...
 * @project lugin-core
 */
public abstract class SimplePaginationMenu extends SimpleMenu {
    ...
    void openToPlayer(@NotNull SimpleMenuManager manager, @NotNull Player player, @NotNull Map<String, Object> initialData) {
        ...
        final PlayerMenuContext ctx = new MenuPaginationContext<>(player, initialData, openHandler,this, manager);
