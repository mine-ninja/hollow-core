...
import io.github.minehollow.sdk.player.wallet.log.WalletBalanceLogConstants;
import io.github.minehollow.sdk.player.wallet.log.WalletBalanceLogType;
...
public class EconomyCommand extends SimpleCommand {
    ...
    public EconomyCommand(BukkitPlatform platform) {
        super("economy", "hollow.core.command.economy");
